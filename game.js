...
function bootGame() {
  try {
    ...
    el.sceneTitle.textContent = "Ошибка запуска";
    el.sceneText.textContent = "Не удалось инициализировать игровой сценарий. Нажмите «Начать заново» или обновите страницу.";
    el.choices.innerHTML = '<button class="choice-btn" id="bootRetry">Повторить запуск</button>';
